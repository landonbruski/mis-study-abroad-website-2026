...
const threeThings = [
  {
    ...
    body: 'Duck Rice at Restaurante O Frade',
  },
  {
    kicker: 'Something I did not expect',
    body: 'I did not expect so many people to be fluent in English and the hills in Lisbon.',
  },
  {
    kicker: 'What I am bringing home',
    body: 'Reciepe for Cod Cakes!',
  },
]
