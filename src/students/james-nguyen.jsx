...
const me = {
  ...
  photo: '/students/james-nguyen/james-nguyen.JPG',
}
...
const favoriteDay = {
  date: 'May 15',
  city: 'Porto',
  title: 'Waves and Wine',
  body: [
    `I really felt connected to the group this day. The surfing was so exhausting but also exhilirating (aside from the cramping in the water) and `,
    `the cooking class had the same vibe as cooking with the family on Thanksgiving. I don't think I saw as many smiles and laughs as I did in that kitchen. The vinho verde certainly helped.`,
  ],
}
